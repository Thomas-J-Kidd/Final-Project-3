...
class Tester:
    def __init__(self, config):
        ...
        self.max_test_images = config.MAX_TEST_IMAGES if hasattr(config, 'MAX_TEST_IMAGES') else 0
        ...
        if self.mode == 1:
            ...
            dataset_test = GoProData(
                ...
                grayscale=self.grayscale == 'True',
                use_gamma=self.use_gamma == 'True',
                max_images=self.max_test_images if self.max_test_images > 0 else None
            )
